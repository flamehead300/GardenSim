...
class PropertyPanel(BoxLayout):
    ...
    def _build_ui(self):
        ...
        self.input_flat = {'background_normal': '', 'background_color': (0.12, 0.13, 0.15, 1), 'foreground_color': (0.95, 0.95, 0.95, 1), 'cursor_color': (0.2, 0.55, 0.85, 1)}
