...
class StorageManager:
    ...
    def build_sync_payload(self, model):
        """Prepare a dictionary payload suitable for server synchronization."""
        return model.to_dict()

    def dumps_sync_payload(self, model):
        """Prepare a compact JSON payload for network submission."""
        return json.dumps(self.build_sync_payload(model), separators=(",", ":"))
